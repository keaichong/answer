<template>
  <div class="item-con">
    <div class="num question-item">
      第
      <span class="remain">{{ itemNum + 1 }}</span> 题
    </div>
    <div class="title question-item">
      {{ problems[itemNum].problemTitle }}
      <span class="triangle"></span>
    </div>
    <div class="question-lists">
      <li v-for="(item, key) in problems[itemNum].answers" :key="key">
          <!-- 循环每道题的选项abcd -->
        <input v-model="chooseId" type="radio" :value="item" :id="item.answerId" name="answer">
