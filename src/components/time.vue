<template>
  <div class="time-score">
    ...
    <div class="score">
      ...
      >
        <g>
          <circle cx="100" cy="100" r="98" stroke="#ffde00" stroke-width="6" fill="#dd4b4b"></circle>
        </g>
        <text x="45" y="100" style="font-size: 48pt;fill: #fff;">100</text>
        <line x1="30" y1="120" x2="170" y2="120" style="stroke:#fff;stroke-width:2"></line>
  ...
  */
  ...
  computed: {
    ...
    remainTime:function(){
     ...
     getMin: function() {
       //如果小于state.allTime小于60,则paresInt是0
       //分钟
      const min = parseInt(this.remainTime / 60);
      return min < 10 ? "0" + min : min;
    },
    getSec: function() {
      //state.allTime小于60 除以60余数 是allTime 
      //秒数
